        ...
        {category.map((item, index) => (
          ...
          >
            <Link
              ...
              className={`${pathname?.includes(item.title.href) && 'bg-blue-500'} group flex flex-col items-center text-sm font-semibold text-gray-600 hover:text-blue-500 md:flex-row md:text-lg lg:text-xl lg:font-semibold`}
            >
