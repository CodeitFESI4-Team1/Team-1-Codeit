...
export default function DropDown({
  ...
  return (
    <Select
      ...
      classNames={{
        wrapper: `${className}`,
        input: `${variant === 'sort' && (isFocused ? 'sort-bg-on pl-10' : 'sort-bg pl-10')} font-pretendard focus:bg-black focus:placeholder:text-white focus:text-white text-base font-medium rounded-xl border-0 h-11 py-2.5 px-3 placeholder-gray-800 `,
